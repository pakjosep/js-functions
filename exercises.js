...
var difference = checkDifference(9);
console.log(difference);
...
var sumDifference = addThenSubtract(bango3, bango4, bango5);
...
var productQuotient = divide(multiply(bango3, bango4), bango5);
console.log(productQuotient);
...
var myFullName = createFullName("Joe", "Pak");
...
function eatFood(firstName, lastName, food){
	return createFullName("Joe", "Pak") + " eats" + " " + food + " everyday for breakfast.";
}
var myFood = eatFood("Joe", "Pak", "chips");
console.log(myFood);
/************** ENGAGE HYPERDRIVE **************/
...
var believeYouCan = allCaps("believe you can and you're halfway there.");

console.log(believeYouCan);
...
var believeYou = oneCap("believe you can and you're halfways there.");
console.log(believeYou);
